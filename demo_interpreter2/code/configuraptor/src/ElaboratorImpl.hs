...
-- keeplook res [] = Right res
-- keeplook resources (((R rname), intpair) : rest) =
--     case lookres resources rname of
--       Left err-> Left err
--       Right rightRes -> keeplook resources rest 
...
--                   Left err -> Left err
--                   Right _ -> checkUndeclare resources rest


elaborate :: IDB -> Either ErrMsg DB
elaborate idb =
    case (runElaba (evalElab idb) []) of
